...
$$ C = \lvert x_{venue} - x_{work} \rvert + \lvert y_{venue} - y_{work} \rvert $$

- Commute Distance

$$ C = \min(\text{work distance}, \text{home distance}, \text{tangent distance}) $$
...
<img src="convex.jpg" height="250px"/>
...
> * Slides are here: https://github.com/HarlanH/loc-opt-demo-slides
